    ...
    with strategy.scope():
        ...
        def step_fn(inputs):
            ...
            with tf.GradientTape() as tape:
                ...
                mean_loss = tf.nn.compute_average_loss(loss, global_batch_size=FLAGS.train_batch_size * len(Config.available_devices))
        ...
        def dist_train_step(dataset_inputs):
            ...
            return strategy.reduce(tf.distribute.ReduceOp.MEAN, per_replica_losses, axis=0)
